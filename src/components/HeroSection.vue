    ...
    <div class="bg-white">
        ...
        <div class="lg:flex items-center gap-20 2xl:justify-between mt-20 2xl:mt-0">
            <div class="2xl:max-w-[700px] px-5 container sm:mx-auto lg:pl-20 2xl:pl-10">
                ...
                <div class="bg-primary rounded-[20px] py-[40px] px-[32px] mt-[55px] mb-10 2xl:mb-0">
                    <ToggleSwitch />
                    <div class="pt-5">
                        <select
                            v-model="selected"
                        ...
                        <div class="flex justify-center sm:justify-start">
                            <button
                                class="bg-blue text-white font-medium text-sm rounded-[25px] px-5 py-2 mt-8 flex gap-4 items-center">
                                Zoek pand
