<template>
    <div class="2xl:max-w-[1640px] container px-5 sm:px-0 sm:mx-auto">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-12 justify-between">
                <div v-for="(slide, index) in displayedSlides" :key="index" class="">
                    <div class="bg-white rounded-2xl sm:w-[100%] h-full flex flex-col justify-between relative">
                        <img
                            :src="slide.image"
                            :alt="'Image ' + (index + 1)"
                        ...
                        <div
                            ...
                            <span class="text-white font-bold text-sm">{{ slide.price }}</span>
                        </div>
                        <div
                        ...
                        <div>
                            <p class="text-darkblue text-medium font-bold px-8 text-left py-5">
                                {{ slide.text }}
                            </p>
                        </div>
